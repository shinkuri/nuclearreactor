...
public class OverclockedHeatVent extends ReactorComponent implements IHeatVent {
	
	private static final int DURABILITY = 1000;
	private static final boolean IS_HEAT_GENERATOR = false;
	
	private static final int SELF_VENT_RATE = 20;
	private static final int REACTOR_VENT_RATE = 36;
	private static final int COMPONENT_VENT_RATE = 0;
	
	protected OverclockedHeatVent(int posX, int posY) {
